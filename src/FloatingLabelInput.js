...
var FloatingLabelInput = React.createClass({
  ...
  render: function() {
    ...
    return(
      <div className="rui-floating-label-input">
        <label htmlFor={this.props.id} className={labelClass}>{this.props.label}</label>
        <input id={this.props.id} type={this.props.type} value={this.props.value} name={this.props.name} ref="input" onChange={this.onChangeHandler} className="rui-floating-label-input__input form-control" />
      </div>
    );
  }
